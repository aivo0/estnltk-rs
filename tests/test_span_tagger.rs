...
/// Basic: match Estonian lemmas against a vocabulary.
#[test]
...
/// Ambiguous input: a span with two annotations, one matches.
#[test]
...
/// Case-insensitive matching with Estonian characters.
#[test]
...
/// Pipeline: regex output → span tagger (simulated).
#[test]
fn test_pipeline_regex_to_span() {
    // Simulated regex tagger output with match_attribute.
...
/// Conflict resolution: KEEP_MAXIMAL with overlapping spans.
#[test]
...
/// Pattern attribute records which pattern matched.
#[test]
...
/// Empty input layer produces empty output.
#[test]
fn test_empty_input() {
    let rules = vec![
